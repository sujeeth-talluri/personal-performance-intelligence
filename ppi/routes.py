...
# _compute_trailing_actuals is imported from services.future_plan_service
...
# _deterministic_progression_weeks, _deterministic_long_run_progression,
# _deterministic_future_week_preview, _build_upcoming_long_runs are imported
# from services.future_plan_service above.
